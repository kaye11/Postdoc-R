...
library(readxl)
influxdata <- read_excel("D:/Postdoc/Experiments/181114 Infection Second/181205 run.xls")
...
influxdata <- read_excel("D:/Postdoc/Experiments/181114 Infection Second/181206 run samples 1-32.xls")
...
library(dplyr)
influxdata$time <- case_when(
  influxdata$samplenumber <17  ~ "96",
  influxdata$samplenumber >16 ~ "120", 
  TRUE ~ as.character(influxdata$samplenumber)
)
...
setwd("D:/R program")
require(openxlsx)
write.xlsx(sum.all, file = "Postdoc-R/Exported Tables/SecondExp_summary_virbac.xlsx")
write.xlsx(influxdata, file = "Postdoc-R/Exported Tables/SecondExp_virbac.xlsx")
