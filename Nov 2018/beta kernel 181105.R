...
ggplot(data=PIC_newdata, aes(x=PICpercellpg, y=beta.pred)) +geom_point(size=5, aes(color=group2))+geom_smooth() +theme_Publication() + scale_y_log10(breaks = breaks, label=scientific_10)
