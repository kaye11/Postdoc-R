...
NAdata <- read.csv("D:/Users/karengb/Exported Tables/NAdata_entityvirconc_mar2021.csv") 
...
write.table (NAdata_merge, "Exported Tables/NAdata_merge_mar2021.csv", sep=",", col.names=T, row.names=F)
