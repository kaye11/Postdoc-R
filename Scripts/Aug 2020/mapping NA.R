...
mp <- function() {
  mapPlot(coastlineWorldFine,  projection="+proj=merc",
          ...
          latitudelim = c(30, 75), col='gainsboro', border="grey", cex.axis=1.5) ##if you change cex, it messes up the text size  BUT if you run it all from the start it is fine 
}
