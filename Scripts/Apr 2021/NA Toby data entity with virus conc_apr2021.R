...
##calculate virnum depending on Ncells_max (1:7, host:virus ratio)
NA_abundancedata$Nvirnum_Cc <- NA_abundancedata$Ncells_max*7
...
write.table (melted_NAabundancedata, "D:/Users/karengb/Exported Tables/NAdata_entityvirconc_apr2021.csv", sep=",", col.names=T, row.names=F)
