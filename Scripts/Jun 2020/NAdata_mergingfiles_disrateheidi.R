...
NAdata <- read.csv("D:/Users/karengb/Exported Tables/NAdata_mergewithAli_withvirnum_raw_200701.csv") #masked 100 m removed
...
write.table (NAdata_merge, "Exported Tables/NAdata_merge_masked.csv", sep=",", col.names=T, row.names=F)
