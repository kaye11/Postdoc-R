...
PIC$Den_cell <- PIC$PICpercell/Eh_vol
...
PIC$SinkVel <- ((2*((2E-6)^2)*(9.8*(86400)^2)*(PIC$Den_celltotal-Den_CH2O))/9*(mu*10))*864 #meter per day
...
PIC <- mutate(PIC, rad = ifelse(group == "naked" ,  1.9,  2.1))
