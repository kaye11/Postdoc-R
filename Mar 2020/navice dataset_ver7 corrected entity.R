...
navice_EI$sucinf_prop <- navice_EI$encounters_propEhV_entity*navice_EI$ads*navice_EI$inf

#calculate total adsorption
navice_EI$adstot <- navice_EI$encountersEhV*navice_EI$ads
navice_EI$adstot_prop <- navice_EI$encounters_propEhV_entity*navice_EI$ads

#melt data to get summary of variables
melted_EI3 <- reshape2::melt(navice_EI %>% select ("date2", "Infection", "entitycode", "virus", "abundance", "encounters_propEhV_entity", "adstot_prop", "sucinf_prop"), id.vars=c("date2", "Infection", "entitycode", "virus"))
...
melted_EI3$variable <- factor (melted_EI3$variable,levels= c("abundance", "encounters_propEhV_entity", "adstot_prop",
                                                             "sucinf_prop"), 
...
write.table(navice_EI, "Postdoc-R/Exported Tables/navice_EI_upper30m_entity.csv", sep=";", col.names=T, row.names=F)
