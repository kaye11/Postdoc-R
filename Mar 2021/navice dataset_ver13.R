...
#get data for betas
BM <- read.csv("D:/R program/Postdoc-R/Exported Tables/beta_master8_BM.csv", sep=";")
DS <- read.csv("D:/R program/Postdoc-R/Exported Tables/beta_master8_DS.csv", sep=";")
...
navice_30m$beta_turb.temp <- (4.2*pi*((navice_30m$disrate/(v))^0.5)*((navice_30m$rad+Rehv)^3))*86400*10^6 
...
write.table(melted_navice, "Postdoc-R/Exported Tables/melted_navice_30m_v13.csv", sep=";", col.names=T, row.names=F)
...
##save datafile
write.table(melted_EI3, "Postdoc-R/Exported Tables/NAVICE_simulation_v13.csv", sep=";", col.names=T, row.names=F)
...
write.table (lithcellehv, "Postdoc-R/Exported Tables/lithcellehv_ratio_v13.csv", sep=";", col.names=T, row.names=F)
