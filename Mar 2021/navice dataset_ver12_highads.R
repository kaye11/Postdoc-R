...
#edit in excel
write.table(melted_navice, "Postdoc-R/Exported Tables/melted_navice_30m_v12_highads.csv", sep=";", col.names=T, row.names=F)
...
probs <- as.data.frame(list (entitycode = as.factor(c("Nc", "Cc", "Li", "Nc", "Cc", "Li")), virus = c("high","high", "high", "low", "low", "low"), ads= c(0.72, 0.20, 0.15, 0.72, 0.20, 0.15),  inf = c(0.3, 0.3, NA, 0.06, 0.06, NA)))
...
#write.table(navice_EI_comb, "Postdoc-R/Exported Tables/navice_EI_comb_upper30m_v12.csv", sep=";", col.names=T, row.names=F)

#write.table(melted_EI3, "Postdoc-R/Exported Tables/melted_EI3_v12.csv", sep=";", col.names=T, row.names=F)
...
write.table(melted_EI3, "Postdoc-R/Exported Tables/melted_navice_30m_v12_meltedEI3.csv", sep=";", col.names=T, row.names=F)
...
write.table (lithcellehv, "Postdoc-R/Exported Tables/lithcellehv_v12.csv", sep=";", col.names=T, row.names=F)
